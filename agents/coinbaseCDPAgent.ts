...
const coinbaseCDPAgent = new AnalyticalBiddingAgent({
  ...
  brandIdentity: {
    ...
    productDescription: 'Trusted crypto infrastructure to power your business - Enterprise-grade server wallets with built-in security, compliance, and scalability',
    targetAudience: 'Web3 developers, blockchain engineers, fintech companies, DeFi builders, enterprise developers integrating crypto payments',
    brandPersonality: 'Professional, trustworthy, enterprise-grade, reliable, developer-first, institutional',
    marketingAngle: 'Build faster with battle-tested infrastructure trusted by thousands of developers worldwide',
    visualStyle: 'Professional Coinbase blue branding (#0052FF), clean modern design, developer-focused imagery (code snippets, APIs, dashboards), tech-forward aesthetic, trust-building elements (security badges, uptime stats)',
    keyMessages: [
